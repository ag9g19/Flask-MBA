...
class InstanceDescriptor(SimpleDescriptor):
    ...
    def __init__(
        ...
        *,
        ...
        .. versionadded:: 5.0
        """
        self.designLocation: AnisotropicLocationDict = designLocation if designLocation is not None else (
            location or {}
        )
...
class BaseDocWriter(object):
    ...
    def _getEffectiveFormatTuple(self):
        ...
        if (
            any(
                isinstance(axis, DiscreteAxisDescriptor)
    ...
    def _addInstance(self, instanceObject):
        ...
        if instanceObject.localisedStyleMapStyleName:
            ...
            for code in languageCodes:
                ...
                localisedStyleMapStyleNameElement.text = instanceObject.getStyleMapStyleName(
                    code
                )
        ...
        if instanceObject.localisedStyleMapFamilyName:
            ...
            for code in languageCodes:
                ...
                localisedStyleMapFamilyNameElement.text = instanceObject.getStyleMapFamilyName(
                    code
                )
    ...
    def readVariableFonts(self):
        ...
        for variableFontElement in self.root.findall(".variable-fonts/variable-font"):
            ...
            variableFont = self.variableFontsDescriptorClass(
                name=name, filename=filename, axisSubsets=axisSubsets, lib=lib,
            )
