...
def main(args=None):
    ...
    parser_compress.add_argument(
        "input_file", metavar="INPUT", help="the input OpenType font (.ttf or .otf)",
    )
    parser_decompress.add_argument(
        "input_file", metavar="INPUT", help="the input WOFF2 font",
    )

    parser_compress.add_argument(
        "-o", "--output-file", metavar="OUTPUT", help="the output WOFF2 font",
    )
    parser_decompress.add_argument(
        "-o", "--output-file", metavar="OUTPUT", help="the output OpenType font",
    )
    ...
    parser_compress.set_defaults(
        subcommand=compress, transform_tables={"glyf", "loca"},
    )
    ...
    configLogger(level=("ERROR" if quiet else "DEBUG" if verbose else "INFO"),)
