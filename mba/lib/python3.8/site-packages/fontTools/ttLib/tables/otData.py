otData = [
    ...
    ("AxisValueArray", [("Offset", "AxisValue", "AxisValueCount", 0, "Axis values"),]),
    (
        "AxisValueFormat1",
        [
    ...
    ("VarRegion", [("struct", "VarRegionAxis", "RegionAxisCount", 0, ""),]),
    (
        "VarRegionList",
        [
    ...
    # ankr
    #
    ("ankr", [("struct", "AnchorPoints", None, None, "Anchor points table."),]),
    (
        "AnchorPointsFormat0",
        [
    ...
    (
        ...
        [
            ...
            (
                ...
                32,
                0,
                u"These are the FUnit distance deltas from the font’s natural baseline to the other baselines used in the font. A total of 32 deltas must be assigned.",
            ),
        ],
    ),
    (
    ...
    ("LocationRecord", [("F2Dot14", "Axis", "AxisCount", 0, "Axis record"),]),
    (
        "TSICRecord",
        [
