...
def parseCursive(lines, font, _lookupMap=None):
    ...
    for line in lines:
        ...
        idx, klass = {"entry": (0, ot.EntryAnchor), "exit": (1, ot.ExitAnchor),}[
            line[0]
        ]
    ...
    def __init__(self, klassName, Format):
        ...
        if Format == 1:
            ...
            def ChainSetRuleData(r, d):
                ...
                (r.BacktrackGlyphCount, r.InputGlyphCount, r.LookAheadGlyphCount,) = (
                    len(d[0]),
                    len(d[1]) + 1,
                    len(d[2]),
                )
...
def main(args=None, font=None):
    ...
    parser = argparse.ArgumentParser("fonttools mtiLib", description=main.__doc__,)
