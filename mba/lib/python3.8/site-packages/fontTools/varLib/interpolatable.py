    ...
    for glyph_name in glyphs:
        ...
        try:
            ...
            for i, (m0, m1) in enumerate(
                zip(allContourIsomorphisms[:-1], allContourIsomorphisms[1:])
            ):
                if len(m0) != len(m1):
                    # We already reported this
                    continue
            ...
            add_problem(
                glyph_name, {"type": "math_error", "master": name, "error": e},
            )
    return problems
...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(
        "fonttools varLib.interpolatable", description=main.__doc__,
    )
    parser.add_argument(
