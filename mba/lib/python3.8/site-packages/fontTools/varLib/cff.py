...
class MergeOutlineExtractor(CFFToCFF2OutlineExtractor):
    ...
    def __init__(
        self, pen, localSubrs, globalSubrs, nominalWidthX, defaultWidthX, private=None
    ):
        super().__init__(
            pen, localSubrs, globalSubrs, nominalWidthX, defaultWidthX, private
        )
...
class CFF2CharStringMergePen(T2CharStringPen):
    ...
    def __init__(
        self, default_commands, glyphName, num_masters, master_idx, roundTolerance=0.5
    ):
        super().__init__(
