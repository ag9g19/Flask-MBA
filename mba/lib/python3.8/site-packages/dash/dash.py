...
class Dash:
    ...
    def serve_layout(self):
        ...
        return flask.Response(to_json(layout), mimetype="application/json",)
    ...
    def long_callback(self, *_args, **_kwargs):  # pylint: disable=too-many-statements
        ...
        def wrapper(fn):
            ...
            return self.callback(
                inputs=dict(
                    _triggers=dict(
                        n_intervals=Input(interval_id, "n_intervals"), cancel=cancel,
                    ),
    ...
    def dispatch(self):
        ...
        try:
            ...
            flask.g.using_args_grouping = not isinstance(  # pylint: disable=assigning-non-slot
                inputs_state_indices, int
            ) and (
                inputs_state_indices != list(range(grouping_len(inputs_state_indices)))
            )
            ...
            flask.g.using_outputs_grouping = not isinstance(  # pylint: disable=assigning-non-slot
                outputs_indices, int
            ) and outputs_indices != list(
                range(grouping_len(outputs_indices))
            )
