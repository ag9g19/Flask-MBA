...
class dtype(Generic[_DTypeScalar_co]):
    ...
    @overload
    def __new__(
        cls, dtype: None | Type[float], align: bool = ..., copy: bool = ...
    ) -> dtype[float_]: ...
    @overload
    def __new__(
...
class _ArrayOrScalarCommon:
    ...
    @overload
    def argmax(
        self, axis: _ShapeLike = ..., out: None = ..., *, keepdims: bool = ...,
    ) -> Any: ...
    @overload
    def argmax(
        self,
    ...
    def newbyteorder(
        self: _ArraySelf, __new_order: _ByteOrder = ...,
    ) -> _ArraySelf: ...
    @overload
    def prod(
        self,
...
_DTypeLike = Union[
    dtype[_ScalarType], Type[_ScalarType], _SupportsDType[dtype[_ScalarType]],
]
...
class generic(_ArrayOrScalarCommon):
    ...
    @overload
    def view(
        self: _ScalarType, type: Type[ndarray[Any, Any]] = ...,
    ) -> _ScalarType: ...
    @overload
    def view(
...
class datetime64(generic):
    ...
    @overload
    def __init__(
        self, value: int, format: _CharLike_co | Tuple[_CharLike_co, _IntLike_co], /,
    ) -> None: ...
...
class poly1d:
    ...
    def __init__(
        self, c_or_r: ArrayLike, r: bool = ..., variable: None | str = ...,
    ) -> None: ...
    def __len__(self) -> int: ...
...
class matrix(ndarray[_ShapeType, _DType_co]):
    __array_priority__: ClassVar[float]
    def __new__(
        subtype, data: ArrayLike, dtype: DTypeLike = ..., copy: bool = ...,
    ) -> matrix[Any, Any]: ...
...
class chararray(ndarray[_ShapeType, _CharDType]):
    ...
    @overload
    def __eq__(
        self: _CharArray[bytes_], other: _ArrayLikeBytes_co,
    ) -> NDArray[bool_]: ...
    @overload
    ...
    @overload
    def __add__(
        self: _CharArray[str_], other: _ArrayLikeStr_co,
    ) -> _CharArray[str_]: ...
    @overload
    def __add__(
        self: _CharArray[bytes_], other: _ArrayLikeBytes_co,
    ...
    def decode(
        self: _CharArray[bytes_], encoding: None | str = ..., errors: None | str = ...,
    ) -> _CharArray[str_]: ...
    def encode(
        self: _CharArray[str_], encoding: None | str = ..., errors: None | str = ...,
    ) -> _CharArray[bytes_]: ...
    @overload
    def endswith(
        self: _CharArray[str_],
    ...
    @overload
    def join(
        self: _CharArray[bytes_], seq: _ArrayLikeBytes_co,
    ) -> _CharArray[bytes_]: ...
    @overload
    def ljust(
        self: _CharArray[str_],
    ...
    @overload
    def lstrip(
        self: _CharArray[str_], chars: None | _ArrayLikeStr_co = ...,
    ) -> _CharArray[str_]: ...
    @overload
    def lstrip(
        self: _CharArray[bytes_], chars: None | _ArrayLikeBytes_co = ...,
    ) -> _CharArray[bytes_]: ...
    @overload
    def partition(
        self: _CharArray[str_], sep: _ArrayLikeStr_co,
    ) -> _CharArray[str_]: ...
    @overload
    def partition(
        self: _CharArray[bytes_], sep: _ArrayLikeBytes_co,
    ) -> _CharArray[bytes_]: ...
    @overload
    def replace(
        self: _CharArray[str_],
